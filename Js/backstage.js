...
function renderCustomerOrders(status = 'false') {
    ...
    targetArr.forEach(function (item, index) {
        let { id, name, comment, price, orderDate, orderTime, takeWay, isPaid, isDone, details } = item;
        ...
        <div class="">
            <div class="foodCard">
                <div class="顧客資訊">
                    ...
                    <div class="d-flex justify-content-between"><span>桌號</span><span>${name}</span></div>
...
function renderNavList() {
    ...
    if (isLogin) {
        ...
        <li class="nav-item" id="navLoginArea">
            <span class="nav-link" href="" id=""><b>${getDataFromLocalStorage('_user').name}</b></span>
        </li>
        ` ;
...
function renderLoginModal(method = 'login') {
    ...
    <div class="d-flex flex-column align-items-center gap-3">
        ...
        <p class="fw-light">
            ...
            <span class="ms-2 finger" onclick="demoInput('')">店家</span>
        </p>
    </div>
    `
        //註冊
